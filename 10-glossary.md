...
The process of examining and evaluating someone else's code changes to ensure quality and adherence to coding standards.

## Collaboration

collaboration is used to explain how multiple individuals work together on a project, often via version control and repositories.

## Commit 

A commit is a snapshot of changes made to a repository, often with a descriptive message explaining the changes.
...
A development practice that involves regularly integrating code changes into a shared repository and automatically testing them.
...
Lables are a way to categorize and organize issues and pull requests. They are color-coded tags that can apply to issues and pull requests to help classify and manage them more effectively.
...
Tags are a valuable for version control and collaboration, helping maintainers and users navigate a project's history and access specific points or versions of code or documentation.

## Version Control

The practice of tracking and managing changes to code and documents, ensuring that different versions can be recorded, compared, and restored.
