...
To get started with the course, simply navigate to the [`What is open source?`](./02-what-is-open-source.md) file in the repository and start reading! Each chapter builds on the previous one, so we recommend reading them in order.
